...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Nov 29, 2019 at 09:48 AM
...
(1, 'Nintendo Switch', 'https://cdn.pocket-lint.com/r/s/320x/assets/images/140007-games-review-nintendo-switch-review-image1-lp6zy9awm0.jpg?v1', 'The Nintendo Switch is a video game console developed by Nintendo, released on March 3, 2017.', '2019-11-27', 7, 19),
...
(7, 'toto@toto.com', 'toto1234', 'Toto', 'WAD', 'https://giantbomb1.cbsistatic.com/uploads/original/0/6087/2437349-pikachu.png'),
...
--
ALTER TABLE `productcategory`
  MODIFY `idProductCategory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
